...
<html lang="en"><head>
    ...
    <link href="jasnybootstrap/css/jasny-bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="maintheme.css" rel="stylesheet">
...
{display:none !important;}</style></head>
  ...
  <body style="">
    <div class="navmenu navmenu-default navmenu-fixed-left">
      <a class="navmenu-brand" href="#">Homepage.io</a>
      <ul class="nav navmenu-nav">
        <li><a href="#">Login</a></li>
        <li><a href="#">Edit Links</a></li>
        <li><a href="#">Choose/Edit Theme</a></li>
        <li><a href="#">Generate Anonoymous URL</a></li>
        <li class="dropdown">
    ...
    <div class="canvas" style="">
      ...
      <!--<div class="container">-->
        ...
        -->
        <iframe id="contentFrame" src="Themes/Arrows/Home.html"></iframe>

      <!--</div>-->
    </div>

    <!-- <iframe id="contentFrame" src="Themes/Arrows/Home.html"/> -->
    ...
    <script src="jasnybootstrap/js/jasny-bootstrap.min.js"></script>
